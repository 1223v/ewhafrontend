...
function ProbSelfStudyAddPage() {
  ...
  return (
    <LectureBackgroudDiv>
      <NavBar />
      <SelfStudyBreadcrumb LectureName={"자습"} />
      <div style={{ display: "flex" }}>
        ...
        <LectureTitleDiv>자습 생성하기</LectureTitleDiv>
      </div>
      <LectureAddFormDiv>
        <LectureNameDiv>
...
export default ProbSelfStudyAddPage;
