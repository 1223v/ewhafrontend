...
function App() {
    ...
    const NewProfessorProbFeedbackPage = Auth(
        ProfessorProbFeedbackPage,
        true,
        3
    ); // 교수 과제 피드백 페이지
    ...
    return (
        <div className="App">
            <Routes>
                ...
                <Route
                    path="/prob/feedback/manage"
                    element={<NewProbSubmitListPage />}
                />
                ...
                />
                <Route
                    path="/prob/list/student"
                    element={<NewProbListStudentPage />}
                />
                <Route
