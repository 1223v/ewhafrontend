...
function ProbModPage() {
	...
	useEffect(() => {
		Axios.get(
			`https://edu-trans.ewha.ac.kr:8443/api/prob/modify?lecture_no=${data.num}&as_no=${data.asnum}`,
			{
			...
			.then((response) => {
				...
				const URL = 'https://edu-trans.ewha.ac.kr:8443/' + response.data.as_list.upload_url;
